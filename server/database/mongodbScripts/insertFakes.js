...
const Models = new ModelHandler()
    .initWithParameters(config.fakeDbUri.username, config.fakeDbUri.password,
    ...
    async.parallel([
      (callback) => {
        new Event({
          ...
          event_location: '',
          event_map: '',
          event_picture: 'https://images.duckduckgo.com/iu/?u=http%3A%2F%2Fwww.proto.gr%2Fsites%2Fdefault%' +
                    '2Ffiles%2Fstyles%2Fcolorbox%2Fpublic%2Fimages%2Ffruits%2Fapple.png&f=1',
